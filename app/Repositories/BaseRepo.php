...
abstract class BaseRepo {
    ...
    {
        return $this->getModel()->orderBy($field, $order);
    }

    //ORDEN RANDOM
    public function orderRandom()
    {
        return $this->getModel()->orderByRaw("RAND()");
    }
    ...
    //SELECIONAR REGISTROS PUBLICADOS Y EN ORDEN
    public function publicadoOrden($column, $order)
    {
        return $this->getModel()->where('publicar', 1)->orderBy($column, $order)->get();
    }
