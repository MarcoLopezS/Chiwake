                                            ...
                                            <tr>
                                               <td style="color:#666;padding:15px; padding-bottom:0;font-size:14px;line-height:20px;font-family:arial;text-align:left">
                                                    ...
                                                    <div style="font-style:normal;padding-bottom:15px;font-family:arial;line-height:20px;text-align:left">
                                                        ...
                                                        <p><span style="font-weight:bold;font-size:16px">Empresa:</span> {{ $empresa }}</p>
                                                        <p><span style="font-weight:bold;font-size:16px">Fecha:</span> {{ $fecha }}</p>
                                                        <p><span style="font-weight:bold;font-size:16px">Duración:</span> {{ $duracion }} horas</p>
                                                        <p><span style="font-weight:bold;font-size:16px">Personas:</span> {{ $personas }}</p>
                                                        <p><span style="font-weight:bold;font-size:16px">Tipo:</span> {{ strtoupper($tipo) }}</p>
                                                        <p><span style="font-weight:bold;font-size:16px">Nombre de Contacto:</span> {{ $contacto }}</p>
                                                        <p><span style="font-weight:bold;font-size:16px">Email de Contacto:</span> {{ $email }}</p>
                                                        <p><span style="font-weight:bold;font-size:16px">Teléfono de Contacto:</span> {{ $telefono }}</p>
